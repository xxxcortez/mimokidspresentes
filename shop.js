...
let updateBag=function(){try{localStorage.setItem("mimo-kids-bag",JSON.stringify(bag))}catch{}
  ...
  if(discount>0){const discountRow=document.createElement('p');discountRow.className='bag-discount';discountRow.textContent='Promoção linha Jack (3 conjuntos por R$ 125,00): -'+discount.toLocaleString('pt-BR',{style:'currency',currency:'BRL'});container.append(discountRow)}
